...
ENVTEST_K8S_VERSION = 1.28.0 # 1.28.0 bumped in https://github.com/kubernetes-sigs/controller-runtime/releases/tag/v0.17.0
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	$(CONTROLLER_GEN) rbac:roleName=manager-role crd webhook paths="./..." output:crd:artifacts:config=helm-charts/starrocks-resource-manager/charts/operator/crds
